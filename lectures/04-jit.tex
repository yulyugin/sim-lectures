...
% Say something about the simulation of device interrupts, page faults, etc?
% Not just straight-line code.
% Mention user-level BT like Pin and SDE?
% Difference system vs user modes?
