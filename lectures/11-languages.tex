...
% TODO: a domain-specific language provides more information and can often be
% better than a manual implementation. Bring up example like register decoder
% for device - doing it manually is hard. Compiler can make really smart
% implementation. Of course a hand-written asm code is better, but in general a
% DSL tends to give you better results as long as the tools are OK.
% DML devices are smaller in terms of data storage at runtime compared to most
% C++ class libraries.
% Point out that learning a library is about the same effort as learning a new
% language. Languages are easy, concepts are hard.
