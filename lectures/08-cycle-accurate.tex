...
% TODO: Bring in the different levels of timing you might strive for: No time,
% some time (Simics), approximate time, cycle-accurate...
% The effort needed to build each. Mention machine-learned approximations.
%
% How simulators are driven: transaction/event-driven or cycle-driven.
% Most truly accurate are cycle-driven.
% But it is possible to get close with events/transactions.
