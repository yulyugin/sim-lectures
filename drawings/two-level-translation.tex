...
\begin{tikzpicture}[>=latex, font=\scriptsize, scale=0.8]
  ...
  \node[fill=white, rotate=90, text width=2cm, inner sep=0pt] at (1.75, -2.5*0.6) {First address translation level};
  ...
  \node[fill=white, rotate=90, text width=2cm, inner sep=0pt] at (1.75, -10.5*0.6) {First address translation level};
  ...
  \node[fill=white, rotate=90, inner sep=0pt] at (5.5, -7*0.6) {Second address translation level};
\end{tikzpicture}
\end{document}
